...
INSERT INTO `user` VALUES (1,'abdo','03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4','01066433044','id21053016453253300039');
...
CREATE TABLE `user_session_data` (
  ...
  `userData` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`sessionID`,`mobileNum`),
  UNIQUE KEY `sessionID_UNIQUE` (`sessionID`),
  UNIQUE KEY `mobileNum_UNIQUE` (`mobileNum`)
...
-- Dump completed on 2021-06-01  8:04:51
